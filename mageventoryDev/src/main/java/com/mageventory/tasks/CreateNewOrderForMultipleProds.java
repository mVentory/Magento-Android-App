...
public class CreateNewOrderForMultipleProds extends AsyncTask<Void, Void, Integer> implements
    ...
    public CreateNewOrderForMultipleProds(OrderListActivity hostActivity,
            Object[] productsToSellJobExtras, Object[] productsToSellAllData, String sku,
            int productID) {
    ...
    protected Integer doInBackground(Void... params) {
        ...
        JobID jobID = new JobID(mProductID, RES_SELL_MULTIPLE_PRODUCTS, mSKU,
        ...
        for (Object product : mProductsToSellAllData)
        {
            ...
            total += new Double((String) productMap.get(MAGEKEY_PRODUCT_QUANTITY))
                    * new Double((String) productMap.get(MAGEKEY_PRODUCT_PRICE));

            orderDetailsItems.add(itemMap);

            JobCacheManager.removeCartItem((String) productMap.get("transaction_id"), job
                    .getSettingsSnapshot().getUrl());
        ...
        orderDetails.put("created_at", (String) android.text.format.DateFormat.format(
        ...
        orderDetails.put("shipments", new Object[] {
            shipmentsMap
        });
        orderDetails.put("status", MULTIPLE_PRODUCTS_ORDER_QUEUED_STATE);

        orderListItem.put("increment_id", mOrderIncrementID);
        orderListItem.put("created_at", (String) android.text.format.DateFormat.format(
                "yyyy-MM-dd hh:mm:ss", new java.util.Date()));
        ...
        JobCacheManager.addToOrderList(orderListItem, new String[] {
    ...
    protected void onPostExecute(Integer result) {
        ...
        myIntent.putExtra(mHostActivity.getString(R.string.ekey_order_increment_id),
                mOrderIncrementID);
