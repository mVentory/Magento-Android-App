# mVentory End User License Agreement

This End-User License Agreement ("License") is a legal agreement between (a) you and (b) mVentory ("Licensor") that governs your use of mVentory Android Application ("the App").
