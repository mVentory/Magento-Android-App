...
public class ExternalImagesEditActivity extends BaseActivity implements MageventoryConstants {
    ...
    private void repositionImages() {
        FrameLayout.LayoutParams paramsCenter = (FrameLayout.LayoutParams) mCenterImage
                .getLayoutParams();
        ...
        FrameLayout.LayoutParams paramsLeft = (FrameLayout.LayoutParams) mLeftImage
                .getLayoutParams();
        ...
        FrameLayout.LayoutParams paramsRight = (FrameLayout.LayoutParams) mRightImage
                .getLayoutParams();
    ...
    private void recreateContentView() {
         ...
         * @Override public boolean onLongClick(View v) { readSKU(); return
         * true; } });
         */
        ...
        viewTreeObserver.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (mTopLevelLayoutWidth != mTopLevelLayout.getWidth()
                    ...
                    mImageCroppingTool.orientationChange(mTopLevelLayout, mTopLevelLayoutWidth,
                    ...
                    mTopLevelLayoutDiagonal = (float) Math.sqrt(mTopLevelLayoutWidth
                            * mTopLevelLayoutWidth
        ...
        mOnGestureListener = new OnGestureListener() {
            ...
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                ...
                if (mImageCroppingTool.isInsideCroppingRectangle(e2.getX(), e2.getY())
                        && mImageCroppingTool.isCroppingShown()) {
                    return false;
                }
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                float flingDistance = (float) Math.sqrt((e1.getX() - e2.getX())
                        * (e1.getX() - e2.getX()) + (e1.getY() - e2.getY())
                        * (e1.getY() - e2.getY()));

                /*
                 * Take distance into consideration when deciding whether the
                 * fling was valid or not.
                 */
                ...
                if (mHorizontalScrolling == false
                    ...
                    if (velocityY < 0 && mImagesLoader.canSwitchLeft()) {
                        ...
                        Animation centerAnimation = new TranslateAnimation(0, 0, 0,
                                -mTopLevelLayoutHeight
                                        - mCurrentImageY);
                        ...
                        Animation leftAnimation = new TranslateAnimation(0, 0, 0,
                                -mTopLevelLayoutHeight
                                        - mCurrentImageY);
                        ...
                        Animation rightAnimation = new TranslateAnimation(0, 0, 0,
                                -mTopLevelLayoutHeight
                                        - mCurrentImageY);
                            ...
                            public void onAnimationEnd(Animation animation) {
                                ...
                                if (mLastReadSKU == null)
                                {
                                    mImagesLoader.queueImage(mCurrentImageIndex,
                                            mLastReadSKU != null ? mLastReadSKU
                                                    : mCurrentSKU, false);
                                }
                                else
                                {
                                ...
                                setCurrentImageIndex(mImagesLoader
                                        .getRightVisibleIndex(mCurrentImageIndex));
                    ...
                    if (velocityX < 0 && mImagesLoader.canSwitchRight()) {
                        ...
                        Animation centerAnimation = new TranslateAnimation(0, -mTopLevelLayoutWidth
                                - mCurrentImageX,
                                0, 0);
                        centerAnimation.setDuration(ANIMATION_LENGTH_MILLIS);
                        centerAnimation.setFillEnabled(true);
        ...
        mTopLevelLayout.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (mImageCroppingTool.mCroppingMode == false && event.getPointerCount() > 1) {
                    ...
                    /*
                     * Reset the current gesture detector. Seems like there is
                     * no better way than just creating a new one.
                     */
                    mGestureDetector = new GestureDetector(mOnGestureListener);
                    // cancelScrolling();
                ...
                if (mImageCroppingTool.mCroppingMode == true) {
                    ...
                    if (event.getPointerCount() > 1) {
                        ...
                        cropRect.left = event.getX(0) < event.getX(1) ? event.getX(0) : event
                                .getX(1);
                        cropRect.right = event.getX(0) > event.getX(1) ? event.getX(0) : event
                                .getX(1) + 1;

                        cropRect.top = event.getY(0) < event.getY(1) ? event.getY(0) : event
                                .getY(1);
                        cropRect.bottom = event.getY(0) > event.getY(1) ? event.getY(0) : event
                                .getY(1) + 1;
                        ...
                        if (event.getAction() != MotionEvent.ACTION_MOVE) {
                            ...
                            if (lastMoveX != -1 && lastMoveY != -1) {
                                if (mImageCroppingTool.isInsideCroppingRectangle(lastMoveX,
                                        lastMoveY)) {
    ...
    private boolean isNearScreenBorder(MotionEvent me)
    {
        ...
        Rect innerScreenRect = new Rect(0 + threshold, 0 + threshold, mTopLevelLayoutWidth
                - threshold, mTopLevelLayoutHeight - threshold);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            if (currentImagePath != null && currentIndexSet == false
                    && files[i].getAbsolutePath().equals(currentImagePath))
            {
    ...
    {
        MotionEvent me1 = MotionEvent.obtain(0, 0, MotionEvent.ACTION_MOVE, -10000, -10000
                + mTopLevelLayoutDiagonal, 0);
        MotionEvent me2 = MotionEvent.obtain(0, 0, MotionEvent.ACTION_MOVE, -10000, -10000, 0);

        /* Imitate up fling */
        return mOnGestureListener.onFling(me1, me2, 0, -mTopLevelLayoutDiagonal
                * (FLING_DETECTION_THRESHOLD + 1));
    }
    ...
    {
        MotionEvent me1 = MotionEvent.obtain(0, 0, MotionEvent.ACTION_MOVE, -10000
                + mTopLevelLayoutDiagonal, -10000, 0);
        MotionEvent me2 = MotionEvent.obtain(0, 0, MotionEvent.ACTION_MOVE, -10000, -10000, 0);

        /* Imitate left fling */
        return mOnGestureListener.onFling(me1, me2, -mTopLevelLayoutDiagonal
                * (FLING_DETECTION_THRESHOLD + 1), 0);
    }
        ...
        AsyncTask<Void, Void, Boolean> mFileCopier = new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                ...
                for (int i = 0; i < filesToUpload.size(); i++) {
                    ...
                    {
                        Log.d(TAG, "Unable to rename file from: "
                                + filesToUpload.get(i).getAbsolutePath() + " to " +
                ...
                JobControlInterface jobControl = new JobControlInterface(
                        ExternalImagesEditActivity.this);

                for (int i = 0; i < productCodeList.size(); i++)
                {
                    ExternalImagesJob ejob = new ExternalImagesJob(
                            System.currentTimeMillis(), productCodeList.get(i), null,
                            mSettings.getProfileID(), 0);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case UPLOAD_IMAGES_DIALOG:
                ...
                alert.setMessage("Upload " + mImagesLoader.getFilesToUploadCount() + " images for "
                        + mImagesLoader.getSKUsToUploadCount() + " products?");
            ...
            case DELETE_SKIPPED_IMAGES_DIALOG:
                ...
                AlertDialog.Builder deleteSkippedAlert = new AlertDialog.Builder(
                        ExternalImagesEditActivity.this);

                deleteSkippedAlert.setTitle("Delete skipped?");
                deleteSkippedAlert.setMessage("Delete " + mImagesLoader.getSkippedCount()
                        + " skipped images?");
            ...
            case JUST_DELETE_SKIPPED_IMAGES_DIALOG:
                ...
                AlertDialog.Builder justDeleteSkippedAlert = new AlertDialog.Builder(
                        ExternalImagesEditActivity.this);

                justDeleteSkippedAlert.setTitle("Delete skipped?");
                justDeleteSkippedAlert.setMessage("No images to upload. Delete "
                        + mImagesLoader.getSkippedCount() + " skipped images?");

                justDeleteSkippedAlert.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                prepareImagesForUpload(true);
                ...
                justDeleteSkippedAlert.setNegativeButton("No",
                        new DialogInterface.OnClickListener() {
            ...
            case NO_IMAGES_TO_REVIEW_OR_UPLOAD_DIALOG:
                ...
                AlertDialog.Builder noImagesAlert = new AlertDialog.Builder(
                        ExternalImagesEditActivity.this);
            ...
            case NO_IMAGES_TO_UPLOAD_DIALOG:
                ...
                AlertDialog.Builder noImagesTpUploadAlert = new AlertDialog.Builder(
                        ExternalImagesEditActivity.this);

                noImagesTpUploadAlert.setTitle("Empty");
                noImagesTpUploadAlert.setMessage("No images to upload.");

                noImagesTpUploadAlert.setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                            }
            ...
            case FAILED_SKU_DECODING_DIALOG:
                ...
                AlertDialog.Builder skuDecodingFailureAlert = new AlertDialog.Builder(
                        ExternalImagesEditActivity.this);

                skuDecodingFailureAlert.setTitle("Re-scan?");
                skuDecodingFailureAlert.setMessage("Cannot read the code. Re-scan?");

                skuDecodingFailureAlert.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                ...
                skuDecodingFailureAlert.setNegativeButton("No",
                        new DialogInterface.OnClickListener() {
            ...
            case ILLEGAL_CODE_DIALOG:
                AlertDialog.Builder illegalCodeAlert = new AlertDialog.Builder(
                        ExternalImagesEditActivity.this);
