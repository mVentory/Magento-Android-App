...
public class CategoryTreeAdapterSingleChoice extends AbstractTreeViewAdapter<Category> implements
    ...
    public CategoryTreeAdapterSingleChoice(Activity activity,
            TreeStateManager<Category> treeStateManager,
    ...
    public final LinearLayout populateTreeItem(final LinearLayout layout,
        ...
        if (mDefaultCategoryID != INVALID_CATEGORY_ID
                && nodeInfo.getId().getId() == mDefaultCategoryID)
        {
