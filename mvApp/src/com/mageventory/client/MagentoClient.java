			...
			public Map<String, Object> run() throws RetryAfterLoginException {
				try {
					...
					Object result = client.call("call", sessionId, "cart.createOrderForProduct", new Object[] { sku,
							price, quantity, customerID, (int)(transactionID%(Integer.MAX_VALUE)), name });
		...
		final MagentoClientTask<Map<String, Object>> task = new MagentoClientTask<Map<String, Object>>() {
			...
			public Map<String, Object> run() throws RetryAfterLoginException {
				try {
					...
					if (searchByBarcode)
					{
						resultObj = client.call("call", sessionId, "catalog_product.fullInfo", new Object[] { productSKU });
					}
					else
					{
						resultObj = client.call("call", sessionId, "catalog_product.fullInfo", new Object[] { productSKU, "sku" });
					}
