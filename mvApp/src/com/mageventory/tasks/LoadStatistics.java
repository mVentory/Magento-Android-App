...
public class LoadStatistics extends AsyncTask<Void, Void, Boolean> implements ResourceConstants, OperationObserver,
	...
	protected Boolean doInBackground(Void... params) {
		if (mForceReload || !JobCacheManager.statisticsExist(mSettingsSnapshot.getUrl()))
		{
			...
			mRequestID = mResHelper.loadResource(mHost, RES_CATALOG_PRODUCT_STATISTICS, mSettingsSnapshot);
			while (true) {
				if (isCancelled()) {
					return true;
				}
