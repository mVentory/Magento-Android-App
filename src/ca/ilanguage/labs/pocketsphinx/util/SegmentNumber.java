...
public class SegmentNumber {
	public static String segmentNum(String wordNumber) {
		...
		String[] hundred = { "one hundred", "two hundred", "three hundred",
		...
		for (int j = 0; j < list.size(); j++) {
			...
			i = list.get(j);
			if (list_and.contains(i)) {
				prev_is_and = 1;
				continue;
			}
			if (list_digit.contains(i)) {
				present_class = 1;
			} else if (list_ten.contains(i)) {
				present_class = 2;
			} else if (list_hundred.contains(i)) {
				present_class = 3;
			} else if (list_special.contains(i)) {
				present_class = 0;
			}
			if (prev_is_and == 1) {
