...
public class ExpressSellActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		P.setDescription(getIntent()
				.getStringExtra(MAGEKEY_PRODUCT_DESCRIPTION));
		P.setPrice(Double.valueOf((getIntent()
				.getStringExtra(MAGEKEY_PRODUCT_PRICE))));
		P.setSku((getIntent().getStringExtra(MAGEKEY_PRODUCT_SKU)));

		((EditText) findViewById(R.id.product_sku_input_express)).setText(P
				.getSku());
		((EditText) findViewById(R.id.description_input_express)).setText(P
				.getDescription());
		((EditText) findViewById(R.id.product_price_input_express)).setText(P
				.getPrice());
	...
	private class CreateOrder extends AsyncTask<Integer, Integer, String> {
		...
		protected String doInBackground(Integer... ints) {
			...
			String soldPrice = ((EditText) findViewById(R.id.product_price_input_express))
					.getText().toString();
			final String qty = ((EditText) findViewById(R.id.quantity_input_express))
					.getText().toString();
			...
			try {
				...
				if (resHelper.isResourceAvailable(ExpressSellActivity.this,
						RES_CART_ORDER_CREATE, null))
					product = resHelper.restoreResource(
							ExpressSellActivity.this, RES_CART_ORDER_CREATE,
							null);
				else
		...
		protected void onPostExecute(String result) {
			if (product != null) {
				...
				// set as old
				resHelper.markResourceAsOld(ExpressSellActivity.this,
						RES_CART_ORDER_CREATE, null);
