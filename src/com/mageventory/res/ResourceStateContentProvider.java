...
public class ResourceStateContentProvider extends ContentProvider implements
	...
	public ResourceStateContentProvider() {
		...
		uriMatcher.addURI(AUTHORITY, ResourceStateSchema.PATH + "/#",
				RESOURCE_STATE_ID);
	}
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		if (id != -1) {
			selection = ResourceStateSchema._ID
					+ "="
					+ id
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		if (DEBUG) {
			String s = q.buildQuery(projection, selection, selectionArgs, null,
		...
		final Cursor c = q.query(db, projection, selection, selectionArgs,
