...
/**
 * Interface for handling image operations inside <code>ProductDetailsActivity</code>
 *
...
public interface IOnClickManageHandler {
	 ...
	 * 
	 * @param layoutToRemove will be the <code>ImagePreviewLayout</code> which will contain an image and a delete button
	 ...
	 * 
	 * @param layoutToEdit will be the <code>ImagePreviewLayout</code> which will contain an image and a delete button
	 * @see ImagePreviewLayout
	 */
	 ...
	 * 
	 * @param layoutToEdit will be the <code>ImagePreviewLayout</code> which will contain an image, a delete button and a checkbox
	 * @see ImagePreviewLayout
	 */
