		...
		if (atrs != null) {
			for (Object elem : atrs) {
				...
				for (final Object obj : customAttrs) {
					...
					final String atrCode = attributeMap.get(
							MAGEKEY_ATTRIBUTE_CODE_ATTRIBUTE_LIST_REQUEST)
							.toString();

					if (atrCode.endsWith("_") == false) {
						String label = (String) ((Map<String, Object>) (((Object[]) attributeMap
						...
						if (TextUtils.equals(setName, label)) {
							 ...
							 */
							attributeMap.put(
									MAGEKEY_ATTRIBUTE_IS_FORMATTING_ATTRIBUTE,
									new Boolean(true));
					...
					String type = (String) attributeMap
							.get(MAGEKEY_ATTRIBUTE_TYPE);

					if (type.equals("multiselect") || type.equals("dropdown")
							|| type.equals("boolean") || type.equals("select")) {
						Object[] options = (Object[]) attributeMap
