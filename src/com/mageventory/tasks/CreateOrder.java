...
public class CreateOrder extends AsyncTask<Integer, Integer, String> implements MageventoryConstants {
    ...
    protected String doInBackground(Integer... ints) {
        ...
        try {
            ...
            if (ResourceServiceHelper.getInstance().isResourceAvailable(mHostActivity,
                    RES_CART_ORDER_CREATE, null))
                product = ResourceServiceHelper.getInstance().restoreResource(mHostActivity,
                        RES_CART_ORDER_CREATE, null);
            else
    ...
    protected void onPostExecute(String result) {
        if (product != null) {
            ...
            // set as old
            ResourceServiceHelper.getInstance().markResourceAsOld(mHostActivity,
                    RES_CART_ORDER_CREATE, null);
