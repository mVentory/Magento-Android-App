...
public class JobProcessorManager implements MageventoryConstants {
	...
	public void process(Context context, Job job) {
		...
		/* In case of product creation job we have two modes: quick sell mode and normal creation mode.
		 * Depending on which mode is choosen from the UI we are using different processor classes to process
		 * the request. */
