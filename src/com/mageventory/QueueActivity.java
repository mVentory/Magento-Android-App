...
public class QueueActivity extends BaseActivity 
{
	...
	private String[] menuItemsFailed = new String [] {DELETE_SELECTED, RETRY_SELECTED, DELETE_MARKED, RETRY_MARKED, MARK_ALL, UNMARK_ALL};
	...
	private SimpleAdapter getSimpleAdapter(boolean pendingTable)
	{
		...
		SimpleAdapter adapter = new SimpleAdapter(this, data, R.layout.queue_item, new String [] {"firstLine", "secondLine"}, new int [] {R.id.firstLine, R.id.secondLine} );
